                            ...
                            {isproduct ? (
                              <>
                                <div className="flex justify-between px-4 pb-4">
                                  <h2 className="text-base px-2 py-2 dark:bg-gray-900 dark:text-white  text-white font-semibold leading-7 text-gray-900">
                                ...
                                {products &&
                                  products.map((item: any) => (
                                    <div className="text-white border border-gray-300 dark:bg-gray-900 dark:text-white flex flex-col">
                                      <div
                                        onClick={() =>
                              ...
                              <>
                                <div className="flex justify-between dark:bg-gray-900 dark:text-white pb-4">
                                  <h2 className="text-base text-center dark:bg-gray-900 dark:text-white font-bold leading-7 px-2 pt-2 text-white">
                                    Lists of Orders
                                  </h2>
                                </div>
                                ...
                                {orders &&
                                  orders.map((item: any, index: number) => (
                                    <div className="border text-white dark:bg-gray-900 dark:text-white border-gray-300 flex flex-col">
                                      <div className="flex flex-col text-white justify-between px-4 py-2 w-full cursor-pointer">
                              ...
                              <>
                                <ul
                                  role="list"
                                  className="divide-y divide-gray-100 text-white dark:bg-gray-900 dark:text-white px-4"
                                >
                                  {users &&
                              ...
                              <>
                                <div className="flex justify-between pb-4">
                                  <h2 className="text-base text-white text-center font-bold leading-7 px-2 pt-2 text-gray-900">
                                    Transactions Made
                                  </h2>
                                </div>
                                ...
                                {allTransactions &&
                                  allTransactions.map(
                                    (item: any, index: number) => (
                                      <div className="border border-gray-300 flex flex-col text-white dark:bg-gray-900 dark:text-white">
