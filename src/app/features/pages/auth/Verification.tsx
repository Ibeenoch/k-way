        ...
        <div className="flex justify-center gap-4 p-4">
          <Link to={`/profile/create/${_id}`}>
            <div className="flex justify-center mt-10">
              <button 
                  className="flex w-full justify-center rounded-md bg-gradient-to-r from-[#33348E] to-[#CC2229] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm duration-200 hover:scale-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-500">                  Complete Profile
              </button>
            </div>
          </Link>
          <Link to="/">
