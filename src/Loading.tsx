...
{ count <= 0 ? (
  <>
  <p style={{ color: 'white', textAlign: 'center'}}> Server taking too long to respond, kindly click the Maven logo to try again </p>
  <p style={{ color: 'white', textAlign: 'center'}}> NB: it may take 5-6 times of trial to load the content on first visit to the site</p>
  </>
) : (
  <>
