...
const [count, setCount] = useState<number>(45)
  ...
  <>
  <p style={{ color: 'black', textAlign: 'center'}}> <strong>Please be patience, while we fetch the content</strong> </p>
  <p style={{ color: 'black', textAlign: 'center'}}> <strong>this may take a while...</strong></p>
