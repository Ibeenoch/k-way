...
const Loading: React.FC = () => {
  ...
  <p style={{ color: 'white', textAlign: 'center'}}> <strong>Please be patience, while we fetch the content</strong> </p>
  <p style={{ color: 'white', textAlign: 'center'}}> <strong>this may take a while...</strong></p>
