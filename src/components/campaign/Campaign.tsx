...
const Campaign = () => {
    ...
    const [isCreatedCampaign, setIsCreatedCampaign] = useState<boolean>(false);
  ...
  return (
    <div>
        ...
        <div onClick={goBack} className='pt-10 pb-3 flex gap-[2px] items-center cursor-pointer'>
        <svg className='w-3 h-3' fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
      ...
      <div className='flex justify-between max-w-xl'>
        <h2 className='text-[#237b7c] text-md font-bold'>Campaign Information</h2>
        <div className='flex items-center bg-gray-200 rounded-md'>
            <p className='text-black text-[11px] py-1 px-3'>Campaign Status</p>
            <div className='border-l-2 border-gray-300 my-2'> &nbsp; </div>
            <p className='text-[#009a18] text-[11px] py-1 px-3'>Active</p>
        </div>
      </div>
{
    isDeletedCampaign ? (
      ...
      <svg
        ...
        <p className='text-black text-center font-bold text-sm py-2'>The campaign you are trying to find has been deleted</p>
        </div>
        </>
    ) : (

      <form className="space-y-1  max-w-xl" >
            <div>
              <label
                htmlFor="campName"
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset sm:text-[11px] sm:leading-6"
                />
              </div>
            </div>
            ...
            <div className="mt-1 grid grid-cols-1 gap-x-6 gap-y-2 sm:grid-cols-6">
                  <div className="sm:col-span-3">
                    <label
                      htmlFor="start"
                      className="block text-xs leading-2 text-gray-600"
                    >
                      Start Date
                    </label>
                    <div className="mt-1">
                      <input
                        ...
                        name="start"
                        id="start"
                        value={moment(singleCampaign.startDate).format('DD/MM/YYYY')}
                        placeholder='27/10/22'
                        disabled
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        id="end"
                        disabled
                        value={moment(singleCampaign.endDate).format('DD/MM/YYYY')}
            ...
            <div>
              ...
              <div className="mt-2">
                <select
                  disabled
                  value={singleCampaign.digestCampaign}
                  className="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset sm:text-[11px] sm:leading-6"
                >
            ...
            <div>
              ...
              <div className="mt-2">
                <select
                  disabled
                  value={singleCampaign.dailyDigest}
                  className="block w-full rounded-md border-0 py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset sm:text-[11px] sm:leading-6"
                >
          ...
          <div className={`${isOpenModal ? 'fixed' : 'hidden'} inset-0 bg-[#e4e4e2]  bg-opacity-50 flex items-center justify-center`}>
     {
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg text-center px-16 py-8" ref={modalRef}>
        ...
        <p className="mt-4 text-[10px]">Are you sure you want to delete {singleCampaign.campaignName} campaign?</p>
        ...
        <p className="my-8 text-[10px]"> {singleCampaign.campaignName} campaign has been deleted</p>
        <div className='flex justify-center items-center gap-4'>
        <Link to="/">
            <button
